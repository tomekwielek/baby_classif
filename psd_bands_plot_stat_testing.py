'''
USe same subjects as the analysis for hd data. TO comprare boxplots with topo maps
'''
import os
import numpy as np
...
import mne
from config import stag_fname, length_issue_sbjs, match_names27, match_names35, markers35, chs_incl
import pandas as pd
...
select_single_channel = 'F4'
balance_sbjs_across_groups = False
...
##################################
band = 'slow'
freq_min, freq_max = (2, 8) # np like subseting( incl, excl)

save_name = 'psd_delta_allchs.csv'
#################################
